...
public:
    CMainParams() {
        ...
        consensus.nTokensDeploymentHeight = 999999999;
        ...
        const char* pszTimestamp = "73,400 New Coronavirus Cases in U.S., Nearing Single-Day Record | Jul 24, 2020 NYTimes";

        genesis = CreateGenesisBlock(pszTimestamp, 1595664655, 869, 0x1f3fffff, 1, 0);
        consensus.hashGenesisBlock = genesis.GetBlockHash();
        assert(consensus.hashGenesisBlock == uint256S("0x002ac53d323efdef375ebc78f5b1d1acc7fb51d392ca7459e7b21ceb642e1900"));
        assert(genesis.hashMerkleRoot == uint256S("0x3d21cc775733067292b98416fa1f4fa21f9f3304fe590e89b70f73c2ecea2405"));
        ...
        chainTxData = ChainTxData{
            // Update as we know more about the contents of the Chellit chain
        ...
        nMaxReorganizationDepth = 120; // 120 at 1 minute block timespan is +/- 120 minutes.
