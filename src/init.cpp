 ...
 * between chellitd, and chellit-qt and non-server tools.
*/
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), CHELLIT_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/ChellitNetwork/ChellitNetwork>";
    const std::string URL_WEBSITE = "<https://chellit.io>";
...
/** Sanity checks
 *  Ensure that Chellit is running in a usable environment with all
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", CHELLIT_CONF_FILENAME)).string());
