...
#ifndef CHELLIT_QT_CHELLITGUI_H
#define CHELLIT_QT_CHELLITGUI_H
...
/**
  Chellit GUI main class. This class represents the main window of the Chellit UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class ChellitGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit ChellitGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~ChellitGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a chellit wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
