...
#ifndef CHELLIT_QT_CHELLITUNITS_H
#define CHELLIT_QT_CHELLITUNITS_H
...
/** Chellit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ChellitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ChellitUnits(QObject *parent);

    /** Chellit units.
      @note Source: https://en.chellit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        CHE,
...
typedef ChellitUnits::Unit ChellitUnit;

#endif // CHELLIT_QT_CHELLITUNITS_H
