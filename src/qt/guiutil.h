...
#ifndef CHELLIT_QT_GUIUTIL_H
#define CHELLIT_QT_GUIUTIL_H
...
/** Utility functions used by the Chellit Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "chellit:" URI into recipient object, return true on successful parsing
