...
#ifndef CHELLIT_QT_OPTIONSMODEL_H
#define CHELLIT_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Chellit client.
...
#endif // CHELLIT_QT_OPTIONSMODEL_H
