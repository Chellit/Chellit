...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(ChellitUnits::CHE),
    ...
    tokendelegate(new TokenViewDelegate(platformStyle, this))
{
    ...
    ui->CHEBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->CHEBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& stake, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance, const CAmount& watchOnlyStake, const CAmount& lockedBalance)
{
    ...
    ui->labelBalance->setText(ChellitUnits::formatWithUnit(unit, balance, false, ChellitUnits::separatorAlways));
    ui->labelUnconfirmed->setText(ChellitUnits::formatWithUnit(unit, unconfirmedBalance + lockedBalance, false, ChellitUnits::separatorAlways));
    ui->labelImmature->setText(ChellitUnits::formatWithUnit(unit, immatureBalance, false, ChellitUnits::separatorAlways));
    ui->labelStake->setText(ChellitUnits::formatWithUnit(unit, stake, false, ChellitUnits::separatorAlways));
    ui->labelTotal->setText(ChellitUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance + lockedBalance, false, ChellitUnits::separatorAlways));
    ui->labelWatchAvailable->setText(ChellitUnits::formatWithUnit(unit, watchOnlyBalance, false, ChellitUnits::separatorAlways));
    ui->labelWatchPending->setText(ChellitUnits::formatWithUnit(unit, watchUnconfBalance, false, ChellitUnits::separatorAlways));
    ui->labelWatchImmature->setText(ChellitUnits::formatWithUnit(unit, watchImmatureBalance, false, ChellitUnits::separatorAlways));
    ui->labelWatchTotal->setText(ChellitUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance + watchOnlyStake, false, ChellitUnits::separatorAlways));
...
void OverviewPage::showTokens()
{
    if (AreTokensDeployed()) {
        ...
        // This keeps the CHE balance grid from expanding and looking terrible when token balance is hidden
