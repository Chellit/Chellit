...
#ifndef CHELLIT_QT_RECEIVECOINSDIALOG_H
#define CHELLIT_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of chellits */
...
#endif // CHELLIT_QT_RECEIVECOINSDIALOG_H
