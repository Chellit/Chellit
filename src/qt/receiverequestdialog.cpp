...
#include "config/chellit-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatChellitURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + ChellitUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatChellitURI(info));
}
