...
#ifndef CHELLIT_QT_SENDTOKENSENTRY_H
#define CHELLIT_QT_SENDTOKENSENTRY_H
...
/**
 * A single entry in the dialog for sending chellits.
...
#endif // CHELLIT_QT_SENDTOKENSENTRY_H
