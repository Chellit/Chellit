...
#include "qt/chellitamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<ChellitAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_chellit-qt -platform xcb      # Linux
//     src/qt/test/test_chellit-qt -platform windows  # Windows
//     src/qt/test/test_chellit-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = ChellitUnits::formatWithUnit(unit, balance, false, ChellitUnits::separatorAlways);
    ...
    // Amount input
    ChellitAmountField* amountInput = receiveCoinsDialog.findChild<ChellitAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: chellit:")) != -1);
