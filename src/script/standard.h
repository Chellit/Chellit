...
#ifndef CHELLIT_SCRIPT_STANDARD_H
#define CHELLIT_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a chellit address
 */
...
/**
 * Generate a Chellit scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // CHELLIT_SCRIPT_STANDARD_H
