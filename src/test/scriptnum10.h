...
#ifndef CHELLIT_TEST_SCRIPTNUM10_H
#define CHELLIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Chellit Core 0.10.0, for cross-comparison.
 */
public:
