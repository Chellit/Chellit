 ...
 */
#ifndef CHELLIT_UTIL_H
#define CHELLIT_UTIL_H
...
extern const char *const CHELLIT_CONF_FILENAME;
extern const char *const CHELLIT_PID_FILENAME;
...
{
    std::string s = strprintf("chellit-%s", name);
