...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the ChellitTestFramework
    pass

class ExampleTest(ChellitTestFramework):
    # Each functional test is a subclass of the ChellitTestFramework class.
    ...
    def custom_method(self):
        ...
        ChellitTestFramework class so other tests can use it."""
