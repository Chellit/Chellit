...
class AssetTest(ChellitTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("CHELLIT1", 1000)
        n0.issue("CHELLIT2", 1000)
        n0.issue("CHELLIT3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="CHELLIT*", verbose=False, count=2, start=-2)
        ...
        chellit_assets = n0.listassets(asset="CHELLIT*", verbose=False, count=2, start=-2)
        assert_equal(len(chellit_assets), 2)
        assert_equal(chellit_assets[0], "CHELLIT2")
        assert_equal(chellit_assets[1], "CHELLIT3")
        self.sync_all()
