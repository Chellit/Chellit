...
class BIP66Test(ChellitTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # chellitd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and chellitd produces more specific reject
            # reasons.
