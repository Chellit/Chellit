...
class TestChellitCli(ChellitTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `chellit-cli getinfo`")
        ...
        self.log.info("Compare responses from `chellit-cli -getinfo` and the RPCs data is retrieved from.")
