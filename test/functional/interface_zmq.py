...
from test_framework.test_framework import ChellitTestFramework, SkipTest
...
class ZMQTest (ChellitTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that chellit has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("chellitd has not been built with zmq enabled.")
