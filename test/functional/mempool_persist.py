...
By default, chellitd will dump mempool on shutdown and
...
class MempoolPersistTest(ChellitTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give chellitd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent chellitd from writing mempool.dat to disk. Verify that `savemempool` fails")
