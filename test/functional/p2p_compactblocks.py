...
# TestNode: A peer we use to send messages to chellitd, and store responses.
...
class CompactBlocksTest(ChellitTestFramework):
    ...
    # This test actually causes chellitd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that chellitd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for chellitd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # chellitd will not send blocktxn responses for blocks whose height is
