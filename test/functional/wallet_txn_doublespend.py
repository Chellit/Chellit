...
class TxnMallTest(ChellitTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 CHE:
        ...
        # First: use raw transaction API to send 1240 CHE to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 CHE coin each
        ...
        # Node0's balance should be starting balance, plus 50CHE for another
        ...
        # Node0's total balance should be starting balance, plus 100CHE for 
